...
<tr class="h-18 border-b border-coolGray-100">
    <th class="whitespace-nowrap px-4 bg-white text-left">
        <div class="flex items-center -m-2">
            ...
            <div class="w-auto p-2">
                <p class="text-xs font-semibold text-coolGray-800">#NAMAKONTAK#</p>
            </div>
        </div>
    </th>
    ...
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-500 text-left">#KETERANGAN#</th>

    <th class="whitespace-nowrap pr-4 bg-white text-sm font-medium text-coolGray-800 text-left">
    <a type="button" href="edit.html?kontakId=#IDEDIT#"> Edit
    </a>
    |
